...
def load_data(messages_filepath, categories_filepath):
    '''
    loading the data from csv and return the merged dataframe of the two .csv
...
def clean_data(df):
    '''
    clean_data: function use to clean data in df
    It creates categories columns, check and fix NaNs, check and fix duplicates
    
    Input:
        df: raw dataframe of messages and categories
    
    Returns:
        df: cleaned dataframe ready to be used for machine learning algorithm
...
def save_data(df, database_filename):
    '''
    save_data: Save data from df into the SQL database
    
    Input:
        df: clean dataframe of messages and categories
        database_filename : filepath to save the SQL database
